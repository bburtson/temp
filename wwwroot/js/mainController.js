...
(function () {
    ...
    function mainController($http, $rootScope, mapController, appAnimations) {
        ...
        vm.selectFatality = function (fatality) {
            vm.selectedFatality = fatality;
        };
        vm.selectAlcohol = function (alcohol) {
            vm.selectedAlcohol = alcohol;
        };
        vm.selectViolationType = function (violationType) {
            vm.selectedViolationType = violationType;
        }
